...
export const translations: Translations = {
    ...
    'garage.modal.vin': { fr: 'VIN (Optionnel)', en: 'VIN (Optional)' },
    ...
    'maintenance.type.periodic': { fr: 'Périodique', en: 'Periodic' },
    ...
    'wallet.type.registration': { fr: 'Carte Grise', en: 'Registration' },
    ...
    'dashboard.periodic_maintenance': { fr: 'Entretien Périodique', en: 'Periodic Maintenance' },
    ...
    'settings.readingMode.on': { fr: 'Activé (Papier & Encre)', en: 'On (Paper & Ink)' },
    'settings.readingMode.off': { fr: 'Désactivé (Mode Nuit)', en: 'Off (Night Mode)' },
    ...
    'settings.maintenance_reminders': { fr: "Rappels d'entretien", en: 'Maintenance Reminders' },
